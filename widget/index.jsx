...
.panel { position: fixed; right: 20px; bottom: 88px; width: 360px; height: 560px; max-height: calc(100vh - 110px);
  background: #faf7f4; border-radius: 14px; box-shadow: 0 12px 40px rgba(0,0,0,.22); display: flex;
  flex-direction: column; overflow: hidden; z-index: 2147483000; color: #222; }
...
.foot { padding: 10px; border-top: 1px solid #ece5de; background: #fff; }
